%testujeme
m_train=10000;  % velkost trenovacej vzorky
m_test=1;
m_val=10000;
rozmer=32;
lamb= 0;
...
n2=200;              % pocet neuronov v 2 vrstve
...
for k=1: m_train/m_batch
    ...
    [a1,a2,Z1,Z2]=f_prop_c2(X_batch,W1,W2,b1,b2,m_batch); % forward propagation
   [dW2,db2,dW1,db1]=back_prop_c2(W1,W2,a1,a2,X_batch,Y_batch,m_batch);  % backward propagation 
    [W1,b1,W2,b2] = upda2_reg(W1,b1,W2,b2,dW1,db1,dW2,db2,alfa,lamb,m_train);  % update vah a biasu
end

 i
     [a1,a2,Z1,Z2]=f_prop_c2(XY(11:n1+10,:),W1,W2,b1,b2,m_train);
    sp_train(i)=spravnost_c(a2,XY(1:10,:))
    [at1,at2,ZZ1,ZZ2]=f_prop_c2(X_val,W1,W2,b1,b2,m_val);
  sp_val(i)=spravnost_c(at2,label_val)
  J_train(i)= naklady_c2(XY(1:10,:),a2,m_train)
  J_val(i)= naklady_c2(label_val,at2,m_val) % hodnota nakl. funkcia
